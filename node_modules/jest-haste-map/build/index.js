  ...
  _buildFileMap() {
    ...
    return Promise.resolve()
      ...
      .then(cachedHasteMap => {
        ...
        try {
          for (
            var _iterator = cachedHasteMap.files[Symbol.iterator](), _step;
  ...
  _processFile(hasteMap, map, mocks, filePath, workerOptions) {
    ...
    const setModule = (id, module) => {
      ...
      if (
        ...
        this._console.warn(message); // We do NOT want consumers to use a module that is ambiguous.
