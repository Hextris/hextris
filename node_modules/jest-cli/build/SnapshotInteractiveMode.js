...
var _utils = require('./reporters/utils');
...
class SnapshotInteractiveMode {
  ...
  _drawUIProgress() {
    ...
    let stats = _chalk().default.bold.dim(
      (0, _utils.pluralize)('snapshot', numRemaining) + ' remaining'
    );
    ...
    if (numPass) {
      stats +=
        ...
        _chalk().default.bold.green(
          (0, _utils.pluralize)('snapshot', numPass) + ' updated'
        );
    }
    ...
    if (this._skippedNum) {
      stats +=
        ...
        _chalk().default.bold.yellow(
          (0, _utils.pluralize)('snapshot', this._skippedNum) + ' skipped'
        );
    }
  ...
  _drawUIDoneWithSkipped() {
    ...
    let stats = _chalk().default.bold.dim(
      (0, _utils.pluralize)('snapshot', this._countPaths) + ' reviewed'
    );
