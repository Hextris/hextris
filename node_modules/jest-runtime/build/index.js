...
class Runtime {
  constructor(config, environment, resolver, cacheFS, coverageOptions) {
    ...
    this._scriptTransformer = new _ScriptTransformer.default(config);
  ...
  static shouldInstrument(filename, options, config) {
    return (0, _shouldInstrument.default)(
      filename,
      {
  ...
  _execModule(localModule, options, moduleRegistry, from) {
    ...
    const wrapper = runScript[_ScriptTransformer.default.EVAL_RESULT_VARIABLE];
...
Runtime.ScriptTransformer = _ScriptTransformer.default;
