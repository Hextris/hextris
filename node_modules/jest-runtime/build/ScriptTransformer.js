...
class ScriptTransformer {
  ...
  transformSource(filepath, content, instrument) {
    ...
    const shouldCallTransform = transform && this._shouldTransform(filename); // That means that the transform has a custom instrumentation
  ...
  _transformAndBuildScript(filename, options, instrument, fileSource) {
    ...
    try {
      ...
      if (
        ...
        throw (0, _helpers.enhanceUnexpectedTokenMessage)(e);
      }
