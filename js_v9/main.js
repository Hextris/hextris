...
function showHelp() {
	...
	$("#inst_main_body").html("<div id = 'instructions_head'>HOW TO PLAY</div><p>Prevent the blocks from reaching past the outer gray hexagon<p><p>" + (settings.platform != 'mobile' ? 'Right + Left Arrow Keys: ' : 'Tap the left and right sides of the screen: ') + " Rotate Hexagon<p>" + (settings.platform == 'mobile' ? 'Tap inner hexagon: ' : "Down Arrow Key: ") + "Speed up Game<p><p> " + "Get 3+ blocks of the same color to touch to clear them and get points<p><p> <span style='color:#f1c40f;'>The</span> <span style='color:#e74c3c'>colored</span> <span style='color:#3498db'>edge</span> <span style='color:#2ecc71'>of</span> the outer hexagon indicates the remaining time of the current combo streak<p><p> By <a href='http://github.com/meadowstream' target='_blank'>Logan Engstrom</a> & <a href='http://github.com/garrettdreyfus' target='_blank'>Garrett Finucane</a><br>Find Hextris on <a href = 'https://itunes.apple.com/us/app/id903769553?mt=8' target='_blank'>iOS</a> & <a href ='https://play.google.com/store/apps/details?id=com.hextris.hextris' target='_blank'>Android</a><br>More @ the <a href ='http://hextris.github.io/' target='_blank'>Hextris Website</a>");
